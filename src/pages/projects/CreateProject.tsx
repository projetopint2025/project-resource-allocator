      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500">Crie um novo projeto a partir do modelo {selectedTemplate}</p>
          </div>
            ...
            {[1, 2, 3, 4].map((stepNumber) => (
              <React.Fragment key={stepNumber}>
                {stepNumber > 1 && (
                  <div 
                    className={`h-1 w-10 ${
                      stepNumber <= step ? "bg-customBlue" : "bg-gray-200"
                    }`}
                  />
                )}
                <div 
                  className={`flex items-center justify-center h-10 w-10 rounded-full text-sm font-medium ${
                    stepNumber === step
                      ...
                      : stepNumber < step
                      ? "bg-customBlue/20 text-customBlue"
