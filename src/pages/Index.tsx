...
import { Calendar, Clock, BarChart3, AlertTriangle, Search, Bell } from "lucide-react";
      ...
      <div className="max-w-8xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button className="rounded-full bg-blue-600 hover:bg-blue-700 text-white px-6 shadow-md">
              Adicionar Projeto
            </Button>
          </div>
        </div>
